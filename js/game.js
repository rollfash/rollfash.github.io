...
(() => {
   ...
   * נ ו-מ מופיעות רק במקומן הרגיל למטה, והאותיות הסופיות אינן מופיעות כלל.
   *
   * מקש המחיקה סוגר את השורה העליונה, ומקש השליחה יושב בשורה משלו למטה.
   * רוחב המקש אחיד בכל השורות (--key-w ב-CSS), והשורות הקצרות ממורכזות. */
  const KB_ROWS = [
    ['ק', 'ר', 'א', 'ט', 'ו', 'פ', 'BACK'],
    ['ש', 'ד', 'ג', 'כ', 'ע', 'י', 'ח', 'ל'],
    ['ז', 'ס', 'ב', 'ה', 'נ', 'מ', 'צ', 'ת'],
